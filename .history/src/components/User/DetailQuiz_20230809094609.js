...
const questions = [
  {
    question: "Ai là người xinh đep nhất trên đời !",
    answers: ["ms Thanh", "ms Hà", "ms Huyền", "ms Vân"],

    correctAnswer: 1,
  },
  {
    question: "Ai đã dặt tên cho dòng sông ",
    answers: ["Long Diên Đạo", "Đỗ Quan Thanh", "Cơ Huyền", "Chị Ngọc"],
    correctAnswer: 2,
  },
